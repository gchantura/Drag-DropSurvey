<script lang="ts">
  ...
  import type { ComponentStyle, InputComponentStyle } from '$lib/types/types';
...
<div class="component-style-editor">
  <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
    <ul class="flex flex-wrap -mb-px">
      <li class="mr-2">
        <button 
          class="inline-block p-2 text-sm {activeTab === 'appearance' ? 'text-blue-600 border-b-2 border-blue-600 dark:text-blue-500 dark:border-blue-500' : 'hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300'}" 
      ...
      <li class="mr-2">
        <button 
          class="inline-block p-2 text-sm {activeTab === 'typography' ? 'text-blue-600 border-b-2 border-blue-600 dark:text-blue-500 dark:border-blue-500' : 'hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300'}" 
      ...
      <li class="mr-2">
        <button 
          class="inline-block p-2 text-sm {activeTab === 'borders' ? 'text-blue-600 border-b-2 border-blue-600 dark:text-blue-500 dark:border-blue-500' : 'hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300'}" 
      ...
      <li>
        <button 
          class="inline-block p-2 text-sm {activeTab === 'spacing' ? 'text-blue-600 border-b-2 border-blue-600 dark:text-blue-500 dark:border-blue-500' : 'hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300'}" 
      ...
      <li>
        <button 
          class="inline-block p-2 text-sm {activeTab === 'states' ? 'text-blue-600 border-b-2 border-blue-600 dark:text-blue-500 dark:border-blue-500' : 'hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300'}" 
  ...
  <div class="mt-4">
        ...
        <div class="border-t pt-4 mt-4">
          <div class="flex items-center mb-3">
            <input
              ...
              on:change={(e) => updateStyle('backgroundGradient', e.target.checked)}
            />
          ...
          {#if componentStyle.backgroundGradient}
            <GradientPicker
              ...
              onChangeDirection={(direction) => updateStyle('backgroundGradientDirection', direction)}
            />
          {/if}
        </div>
    ...
    {:else if activeTab === 'typography'}
      <div class="space-y-4">
        ...
        {#if isInputType}
          <div class="border-t pt-4 mt-4">
            <h4 class="text-sm font-medium mb-3">Label Settings</h4>
            <div class="grid grid-cols-2 gap-4">
              <TextInput
